...
validKeys = {'r', 'g', 'ESCAPE'}; % Adjust as needed: 'r' is the upper stimulus
scannerKeys = {'s', 'ESCAPE'}; % When waiting for scanner: what to look for
delay = 0.004;
recordFieldmap = false; % Should we record a field map?
fontSize = 50; % Stimulus font size; instructions are 70% of that
...
anyKeyToContinue = fileread("instructions/handcheck/press_any_to_continue.fr.txt");
